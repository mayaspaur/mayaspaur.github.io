...
This is a bar graph displaying the total number of restaurant inspections conducted in each borough, limited to inspections that received an A, B or C grade. 
...
This is a boxplot featuring the distribution of scores from the restaurant inspections for each borough, limited to inspections that received an A, B or C grade.
